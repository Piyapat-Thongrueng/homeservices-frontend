...
export default function Footer() {
  return (
    <footer className="w-full">
      ...
      <div className="bg-utility-white py-8 px-4 md:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-8">
            ...
            <div className="flex flex-col gap-2 text-gray-800">
              <div className="flex items-center gap-3">
                ...
                <a href="tel:080-540-6357" className="body-2 font-normal hover:text-blue-600 transition-colors">
                  080-540-6357
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-gray-500" />
                <a href="mailto:contact@homeservices.co" className="body-2 font-normal hover:text-blue-600 transition-colors">
      ...
      <div className="bg-gray-100 py-4 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-gray-700">
            ...
            <div className="flex flex-col md:flex-row md:flex-wrap md:items-center gap-6 order-1 md:order-2">
              <a
                href="#"
